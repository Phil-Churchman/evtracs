/* Tracking data page. The description is static markup; the only thing worth
 * wiring up is the walkthrough link, which comes from the same video catalogue
 * the overview uses so there is one record of that url. */
(function () {
  "use strict";
  ...
  E.boot("tracking.html", function () {
    return E.fetchJson(STEPS_URL)
      .then(function (catalogue) {
        ...
        var link = document.getElementById("trackingVideo");
